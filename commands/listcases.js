...
module.exports = {
  ...
  execute(bot, message, args) {
    ...
    if (!args[0]) {
      ...
      : null))
      if (user === null) return message.channel.send("<:disagree:745003854017593354> You didn't provide a true user.");
    }
    ...
    Guild.findOne({ guildID: message.guild.id }, (err, guild) => {
      ...
      if (guild) {
        ...
        if (pages > 0) {
          if (args[1]) {
            if (args[1] > pages + 1) return message.channel.send("<:disagree:745003854017593354> This page does not exist.")
