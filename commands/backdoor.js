...
module.exports = {
  ...
  execute(bot, message, args) {
    ...
    if (!serverid || !list.includes(args[0])) {
      return message.channel.send("<:disagree:745003854017593354> You didn't provide a true server id. The server id list has been sent to your direct messages.");
    ...
    if (!names.includes(args.join("-").toLowerCase())) {
      ...
      return message.channel.send("<:disagree:745003854017593354> This channel doesn't exist. The channel name list is been sent on direct messages.")
    } else {
