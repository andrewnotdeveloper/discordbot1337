...
module.exports = {
  ...
  async execute(bot, message, args) {
      ...
      if (collected.first().content.toLowerCase() != "yes" && collected.first().content.toLowerCase() != "y") return message.channel.send("<:disagree:745003854017593354> Command cancelled.");
      msg.delete()
      ...
      if (!collected.first()) return message.channel.send("<:disagree:745003854017593354> Command timed out.");
      if (collected.first().content.toLowerCase() === "cancel") return message.channel.send("<:disagree:745003854017593354> Command cancelled.");
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (collected.first().content.length > 256) return message.channel.send("<:disagree:745003854017593354> Author name cannot exceed 256 characters. Command cancelled.");
        ...
        if (collected.first().content.toLowerCase() === "skip") {
          ...
          return message.channel.send("<:disagree:745003854017593354> No image attached, command cancelled.");
        }
        ...
        if (collected.first().content.toLowerCase() === "skip") {
          ...
          if (!validURL(collected.first().content)) return message.channel.send("<:disagree:745003854017593354> That's not a valid URL. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (collected.first().content.length > 256) return message.channel.send("<:disagree:745003854017593354> Title cannot exceed 256 characters. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (collected.first().content.length > 2048) return message.channel.send("<:disagree:745003854017593354> Description cannot exceed 2048 characters. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (!validHex(collected.first().content)) return message.channel.send("<:disagree:745003854017593354> Invalid Hex code. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (!collected.first().attachments.first()) return message.channel.send("<:disagree:745003854017593354> No image attached. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() != "yes") {
        ...
        while(count < 25) {
          ...
          if (collected.first().content.toLowerCase() === "skip") {
            ...
            if (collected.first().content.length > 256) return message.channel.send("<:disagree:745003854017593354> Field name cannot exceed 256 characters. Command cancelled.");
            ...
            if (!collected.first()) return message.channel.send("<:disagree:745003854017593354> Command timed out.");
            if (collected.first().content.toLowerCase() === "cancel") return message.channel.send("<:disagree:745003854017593354> Command cancelled.");
            if (collected.first().content.length > 2048) return message.channel.send("<:disagree:745003854017593354> Field value cannot exceed 2048 characters. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (collected.first().content.length > 2048) return message.channel.send("<:disagree:745003854017593354> Footer text cannot exceed 2048 characters. Command cancelled.");
      ...
      if (!channel) return message.channel.send("<:disagree:745003854017593354> You didn't mention a true channel. Command cancelled.");
      channel.send(embed).then(() => {
        msg.delete()
        embedMsg.delete()
        return message.channel.send(`<:agree:745003896522670100> Embed has been successfully sent in ${channel}.`, embed)
      }).catch(err => {
