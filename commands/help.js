  ...
  execute(bot, message, args) {
    ...
    if (!args[0]) {
      ...
      return message.author.send(helpEmbed)
        ...
        .catch(error => {
          message.channel.send("It seems like I cant DM you. Please enable your DMs!");
        });
    } else if (args[0]) {
      ...
      if (!command) {
        return message.channel.send(`This command doesn't exists! use \`${prefix}commands\` command to get into commands.`);
      }
